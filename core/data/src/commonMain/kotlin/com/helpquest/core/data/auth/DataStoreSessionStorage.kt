...
class DataStoreSessionStorage(
    ...
    override fun observeAuthInfo(): Flow<AuthInfo?> {
        return dataStore.data.map { preferences ->
            ...
            serializedJson?.let {
                ...
                //TODO: add decryption of serialized (maybe use Serializer functions)
            }
        }
    }
    ...
    override suspend fun set(info: AuthInfo?) {
        ...
        val serialized = json.encodeToString(info.toAuthInfoDto())
        //TODO: add encryption of serialized (maybe use Serializer functions)
