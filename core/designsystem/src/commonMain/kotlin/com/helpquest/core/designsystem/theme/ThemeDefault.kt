...
val LightExtendedColorsDefault = ExtendedColors(
...
val DarkExtendedColorsDefault = ExtendedColors(
    primaryHover = HelpQuestBrand600,
    destructiveHover = HelpQuestRed600,
    destructiveSecondaryOutline = HelpQuestRed200,
...
val LightColorSchemeDefault = lightColorScheme(
    primary = HelpQuestBrand500Prod,
    onPrimary = HelpQuestBrand1000Prod,
    primaryContainer = HelpQuestBrand100,
    onPrimaryContainer = HelpQuestBrand900Prod,
    ...
    tertiary = HelpQuestBrand900Prod,
    onTertiary = HelpQuestBase0,
    tertiaryContainer = HelpQuestBrand100,
    onTertiaryContainer = HelpQuestBrand1000Prod,
    ...
    background = HelpQuestBrand1000Prod,
...
val DarkColorSchemeDefault = darkColorScheme(
    primary = HelpQuestBrand500Prod,
    onPrimary = HelpQuestBrand1000Prod,
    primaryContainer = HelpQuestBrand900Prod,
    ...
    tertiary = HelpQuestBrand500Prod,
    onTertiary = HelpQuestBase1000,
    tertiaryContainer = HelpQuestBrand900Prod,
    onTertiaryContainer = HelpQuestBrand500Prod,
