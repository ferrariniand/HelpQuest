...
import helpquest.core.designsystem.generated.resources.dismiss_dialog
...
fun DestructiveConfirmationDialogLightPreview() {
    HelpQuestTheme {
        DestructiveConfirmationDialog(
            title = "Delete Title Example?",
...
fun DestructiveConfirmationDialogDarkPreview() {
    HelpQuestTheme(
        darkTheme = true
    ) {
        DestructiveConfirmationDialog(
