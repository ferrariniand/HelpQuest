package com.helpquest.core.test.service.notification
...
class FakeDeviceTokenService : DeviceTokenService {
    ...
    var registerTokenResult: EmptyResult<DataError.Remote> =
        Result.Success(Unit)

    var unregisterTokenResult: EmptyResult<DataError.Remote> =
        Result.Success(Unit)
